...
export function generateExcelFile(config) {
  ...
  // Tab 1: Copy Template
  const copyData = generateCopyTab(deliverables, markets, contentRows, leadLanguage);
  ...
  // Freeze panes (3 header rows + first 3 columns: Deliverable, Name, Lead Language)
  copySheet['!freeze'] = { xSplit: 3, ySplit: 3 };
...
function generateCopyTab(deliverables, markets, contentRows, leadLanguage) {
