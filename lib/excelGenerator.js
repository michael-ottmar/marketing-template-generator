...
async function generateCopyTab(worksheet, deliverables, markets, contentRows, leadLanguage) {
  ...
  deliverables.forEach(deliverable => {
    deliverable.sections.forEach(section => {
      // Handle nested subsections (new structure for PDP)
      if (section.subsections) {
          ...
          subsection.fields.forEach(field => {
            ...
            if (contentRows) {
              ...
              const contentRow = contentRows.find(
                cr => cr.deliverable === subsection.name && cr.field === field
              );
        ...
        // Fallback for flat structure (Display Ads, CRM, Landing Page)
